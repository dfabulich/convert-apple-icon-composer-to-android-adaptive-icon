 ...
 */
export async function generateAdaptiveIconXml(outputPath, backgroundDrawable, foregroundMipmap) {
 ...
 */
export async function createAndroidResourceStructure(baseOutputDir, iconData, fullPngPath, backgroundPngPath, foregroundPngPath) {
  // Create directories
